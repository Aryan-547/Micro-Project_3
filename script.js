...
function getAllAboveCalorieDAta() {
  const newArr = foodOriginalData.filter((item) => item.calorie >100);
  console.log(newArr);
}

function getAllBelowCalorieDAta() {
  const newArr = foodOriginalData.filter((item) => item.calorie <100);
  console.log(newArr);
}

const duplicateData = [foodOriginalData];
function sortByProperty(property) {
  const sortedData =
    property === "proteins"
      ? duplicateData.sort((a, b) => b.protiens - a.protiens)
      : property === "cab"
      ? duplicateData.sort((a, b) => a.cab - b.cab)
      : [];
  console.log(sortedData);
}

sortByProperty("proteins");
sortByProperty("cab");
